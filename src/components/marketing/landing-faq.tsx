...
const faqs = [
  {
    q: "Кто такой менеджер вводного урока (МВУ)?",
    a: "Это специалист, который проводит онлайн-встречи с клиентами, демонстрирует IT-продукты и помогает принять решение о покупке. Вы закрываете сделку на этапе первого контакта и напрямую влияете на рост компании и свой доход.",
  },
  {
  ...
  },
  {
    ...
    a: "Четыре дня интенсивной онлайн-практики с живым тренером: теория, ролевые игры, разбор возражений и подготовка к трудоустройству.",
  },
  {
    q: "Можно ли совмещать с основной работой?",
    a: "Да. Формат удалённый, занятия проходят в сфокусированном интенсиве, а дальнейшая работа МВУ также строится онлайн.",
  },
  {
